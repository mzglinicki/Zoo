...
public class Constans {
	...
	// List of animals
	public static final String SNAKES = "Wê¿e";
	public static final String TIGRES = "Tygrysy";
	public static final String GIRAFFE = "¯yrafy";
	...
	public static final String LENGTH_OF_PREGNANCY = "D³ugoœæ ci¹¿y: ";
	...
	public static final String LEAVES = "Liœcie";
	public static final String MEAT = "Miêso";
	...
	public static final String SEX = "P³eæ";
	public static final String NAME = "Imie";
	public static final String NUMBER = "Lp.";

	// Snakes
	public static final String SNAKE_SOUND = "Sss...";

	// Tiger
	public static final String TIGER_SOUND = "wof?";

	// Giraffe
	public static final String GIRAFFE_SOUND = "yyyPsss";
	...
	public static final String LACK_OF_CAGES = "Nie mamy a¿ tyle miejsca";
